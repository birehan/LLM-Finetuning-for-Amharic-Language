  ...
  const [messages, setMessages] = useState([
    {
      role: "system",
      message:
        "ሰላም! እኔ አድባር AI ነኝ፣ የእርስዎ የማስታወቂያ ትውልድ ረዳት። ዛሬ በማስታወቂያ ፈጠራህ እንዴት ልረዳህ እችላለሁ?",
    },
  ]);
        ...
        <ul className="space-y-4">
          {messages.map((message, index) => {
            return (
              ...
              >
                {message.role === "system" ? (
                <div style={{height:'80px', width:"40px", borderRadius:"50%"}}>
                  <img src="assets/logo.jpeg" style={{borderRadius:"20px"}} alt="logo" />
